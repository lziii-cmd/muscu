...
CREATE TYPE "public"."slot" AS ENUM('salle', 'matin', 'soir', 'libre');--> statement-breakpoint
...
CREATE TABLE "exercises" (
	...
	"execution" text,
	"common_mistake" text,
	"measure_label" text DEFAULT 'reps' NOT NULL,
...
CREATE UNIQUE INDEX "water_logs_date_key" ON "water_logs" USING btree ("user_id","date");